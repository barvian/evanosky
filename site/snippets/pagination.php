  ...
  <div class="layout"><div class="layout__unit">
    <ul class="pagination__menu">
      ...
      <li class="pagination__prev">
        ...
        <a class="pagination__link" href="<?php echo $url($prev) ?>" target="<?php echo $target($prev) ?>">
          <?php snippet('sprite', [
      ...
      <li class="pagination__next">
        ...
        <a class="pagination__link" href="<?php echo $url($next) ?>" target="<?php echo $target($next) ?>">
          <?php snippet('sprite', [
            'class' => 'pagination__caret',
